...
public class ModEnchantments {
    ...
    public static void bootstrap(BootstrapContext<Enchantment> context) {
        ...
        register(context, FROSTBRAND, Enchantment.enchantment(Enchantment.definition(items.getOrThrow(ItemTags.WEAPON_ENCHANTABLE),
                ...
                .withEffect(EnchantmentEffectComponents.LOCATION_CHANGED, new ReplaceDisk(new LevelBasedValue.Clamped(LevelBasedValue.perLevel(4.0F, 3.0F), 0.0F, 16.0F), LevelBasedValue.constant(3.0F), new Vec3i(0, -1, 0), Optional.of(BlockPredicate.allOf(new BlockPredicate[]{BlockPredicate.matchesBlocks(new Block[]{Blocks.FIRE, Blocks.SOUL_FIRE})})), BlockStateProvider.simple(Blocks.AIR), Optional.of(GameEvent.BLOCK_PLACE)), LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, net.minecraft.advancements.critereon.EntityPredicate.Builder.entity().flags(net.minecraft.advancements.critereon.EntityFlagsPredicate.Builder.flags().setOnGround(true))))
                .withEffect(EnchantmentEffectComponents.LOCATION_CHANGED, new ReplaceDisk(new LevelBasedValue.Clamped(LevelBasedValue.perLevel(4.0F, 3.0F), 0.0F, 16.0F), LevelBasedValue.constant(3.0F), new Vec3i(0, 0, 0), Optional.of(BlockPredicate.allOf(new BlockPredicate[]{BlockPredicate.matchesBlocks(new Block[]{Blocks.FIRE, Blocks.SOUL_FIRE})})), BlockStateProvider.simple(Blocks.AIR), Optional.of(GameEvent.BLOCK_PLACE)), LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, net.minecraft.advancements.critereon.EntityPredicate.Builder.entity().flags(net.minecraft.advancements.critereon.EntityFlagsPredicate.Builder.flags().setOnGround(true))))
                .withEffect(EnchantmentEffectComponents.LOCATION_CHANGED, new ReplaceDisk(new LevelBasedValue.Clamped(LevelBasedValue.perLevel(4.0F, 3.0F), 0.0F, 16.0F), LevelBasedValue.constant(3.0F), new Vec3i(0, 1, 0), Optional.of(BlockPredicate.allOf(new BlockPredicate[]{BlockPredicate.matchesBlocks(new Block[]{Blocks.FIRE, Blocks.SOUL_FIRE})})), BlockStateProvider.simple(Blocks.AIR), Optional.of(GameEvent.BLOCK_PLACE)), LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, net.minecraft.advancements.critereon.EntityPredicate.Builder.entity().flags(net.minecraft.advancements.critereon.EntityFlagsPredicate.Builder.flags().setOnGround(true))))
